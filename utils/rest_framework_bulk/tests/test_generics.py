...
class TestBulkAPIView(BaseTestCase):
    def setUp(self):
    ...
    def test_delete_not_filtered(self):
        ...
        response = self.client.delete("/api/simple/")
    ...
    def test_delete_filtered(self):
        ...
        response = self.client.delete("/api/filtered/")
    ...
    def test_options(self):
        ...
        """
        response = self.client.options("/api/simple/")

        self.assertEqual(response.status_code, status.HTTP_200_OK)


class TestBulkAPIViewSet(BaseTestCase):
    """
